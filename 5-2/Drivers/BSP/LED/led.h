...
#define LED4_GPIO_CLK_ENABLE()          do{ __HAL_RCC_GPIOF_CLK_ENABLE(); }while(0)             /* PF口时钟使能 */

#define LED5_GPIO_PORT                  GPIOF
#define LED5_GPIO_PIN                   GPIO_PIN_4
#define LED5_GPIO_CLK_ENABLE()          do{ __HAL_RCC_GPIOF_CLK_ENABLE(); }while(0)             /* PF口时钟使能 */
...
#define LED5(x)   do{ x ? \
                      ...
                      HAL_GPIO_WritePin(LED5_GPIO_PORT, LED5_GPIO_PIN, GPIO_PIN_RESET); \
                  }while(0)       /* LED5 = GREEN */
...
#define LED4_TOGGLE()    do{ HAL_GPIO_TogglePin(LED4_GPIO_PORT, LED4_GPIO_PIN); }while(0)       /* LED2 = !LED2 */
#define LED5_TOGGLE()    do{ HAL_GPIO_TogglePin(LED5_GPIO_PORT, LED5_GPIO_PIN); }while(0)       /* LED2 = !LED2 */
